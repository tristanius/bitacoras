            ...
            <tbody>
              ...
              <tr>
                ...
                <td valign="top" style="padding-left: 15px;">
                  <h5 style="margin-top: 15px;">Headphone Pro Case, Soft Silicone Skin Case.</h5>
                </td>
                <td valign="top" style="padding-left: 15px;">
              ...
              <tr>
                ...
                <td valign="top" style="padding-left: 15px;">
                  <h5 style="margin-top: 15px;">Solid Teak Wood Arm Chair Contemporary Design</h5>
                </td>
                <td valign="top" style="padding-left: 15px;">
                  <h5 style="font-size: 14px; color:#444;margin-top: 10px;">QTY : <span>1</span></h5>
                </td>
                ...
                <td style="padding: 30px;">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px auto 0;">
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <p style="font-size:14px; margin:8px 0; color:#717171;">2023 - 24 CopyRight by Themeforest powered by PixelStrap</p>
                        </td>
                      </tr>
                      <tr>
