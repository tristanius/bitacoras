            ...
            <tr class="header">
              ...
              <td class="menu" align="right" style="padding-right:15px;">
                <ul>
                  ...
                  <li style="display: inline-block;text-decoration: unset"><a href="{{ route('list-wish') }}">Whishlist</a></li>
            ...
            <tr>
                ...
                <div class="product-box hover">
                  ...
                  <div class="product-info">
                    <div class="rating" style="margin-bottom:5px;"><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i></div><a href="javascript:void(0)" tabindex="0" style="text-align: center;">
                      <h6 style="text-align: center;">Samsung Smart Phone </h6></a>
              ...
              <td>
                <div class="product-box hover">
                  ...
                  <div class="product-info">
                    <div class="rating" style="margin-bottom:5px;"><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i></div><a href="javascript:void(0)" tabindex="0" style="text-align: center;">
                      <h6 style="text-align: center;">Black Fabric Chair</h6></a>
              ...
              <td>
                <div class="product-box hover">
                  ...
                  <div class="product-info">
                    <div class="rating" style="margin-bottom:5px;"><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i><i class="fa fa-star" style="color:#e6c830;"></i></div><a href="javascript:void(0)" tabindex="0" style="text-align: center;">
                      <h6 style="text-align: center;">Men's T-shirt</h6></a>
                    <h4 style="text-align: center;">$35.00</h4>
                  </div>
                </div>
              </td>
            </tr>
        ...
        <table class="main-bg-light" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:40px;">
          <tbody>
            ...
            <tr class="add-with-banner" align="center">
              ...
              <td>
                <div style="border-top:1px solid #534686; mso-line-height-rule: exactly;" data-border-bottom-color="Week Border"></div><a href="javascript:void(0)">
                ...
                <div style="border-bottom:1px solid #534686; mso-line-height-rule: exactly;" data-border-bottom-color="Week Border"></div>
              </td>
            </tr>
            <tr>
              <td height="45" style="mso-line-height-rule:exactly; line-height:45px;"></td>
