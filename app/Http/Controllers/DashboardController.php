...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $stats = [
            'total_hours' => LogEntry::where('is_active', true)->sum('total_time'),
        ...
        $userStats = [
            'my_total_hours' => LogEntry::where('pilot_id', $user->id)->where('is_active', true)->sum('total_time'),
        ...
        $stats = [
            'total_hours' => LogEntry::where('is_active', true)->sum('total_time'),
            'flights_month' => LogEntry::where('is_active', true)->whereMonth('date', now()->month)->count(),
            'active_aircraft' => Aircraft::where('is_active', true)->count(),
            'pending_validations' => LogEntry::where('is_active', true)->where('validated', false)->count(),
        ];
